...
| `cli/` | the four subcommands (`import`/`run`/`export`/`writeback`), config-driven assembly, the pre-server checks, and the retrieval/injection seams |
