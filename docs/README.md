...
| [`api/`](api/README.md) | you need the exhaustive per-symbol API reference: every public module/class/method/function across the framework and its 6 example recipes, with real argument types, return meaning, side effects, and where two drivers of the same port diverge |
